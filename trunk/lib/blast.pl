...
$USAGE = "
 ...
 Where DBA_FILE is the database and OBJ_NAME is the name of the
 sequence object which contains the query sequence. If OBJ_NAME
 contains more than one sequence, all will be used in turn as
 a query sequence.
